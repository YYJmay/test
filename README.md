...
- Username/password SSH connection
...
### Practical Workflows
- Configure complete scientific computing environment
- Run GPU-accelerated computations
- Manage long-running training tasks
...
1. Complete all examples in `DEMO.ipynb`
2. Try your own data analysis or machine learning project
3. Use tmux for long training runs
...
### Jupyter kernel selection error?
1. Click kernel selector in top-right
2. Select "Python (sci, remote)"
3. If not available, re-register kernel:
   ```bash
